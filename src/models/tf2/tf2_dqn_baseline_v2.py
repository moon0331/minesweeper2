"""This code may not be run because some part was edited.
Source: https://github.com/chagmgang/tf2.0_reinforcement_learning/blob/master/rainbow/dqn.py
"""
...
class Agent:
    ...
    def update(self):
        ...
        with tf.GradientTape() as tape:
            ...
            # error = huber_loss(main_value, target_value)
    ...
    def run(self):
        ...
        while True:
            ...
            if episode and episode % 20 == 0:
                print("n_episode: {}, score: {:.1f}, n_buffer: {}, eps: {:.1f}%".format(episode, score / 20, len(self.memory), epsilon * 100))
                score = 0
                self.update_target()
