...
class DQN(tf.keras.model):
    ...
    def __init__(self, obs_dim, acs_dim):
        ...
        self.fc1 = Dense(24, activation='relu', kernel_initializer='he_uniform')
        self.fc2 = Dense(24, activation='relu', kernel_initializer='he_uniform')
...
class TF2DQNAgent:
    ...
    def __init__(self, env, obs_dim, acs_dim, steps, gamma=0.99, epsilon=1.0, epsilon_decay=0.999, buffer_size=2000, \
                batch_size=64, target_update_step=100):
        self.env = env
    ...
    def learn(self, obs, acs, next_obs, rewards, dones):
        ...
        self.optimizer.apply_gradient(zip(grads, self.q_net.trainable_weights))
...
if __name__ == '__main__':
    ...
    agent = TF2DQNAgent(env, obs_dim, acs_dim, 10000)
    agent.train()